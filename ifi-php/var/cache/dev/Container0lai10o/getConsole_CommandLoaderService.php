...
return $this->services['console.command_loader'] = new \Symfony\Component\Console\CommandLoader\ContainerCommandLoader(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Command\\AppCreateTournamentCommand' => function () {
    $f = function (\App\Command\AppCreateTournamentCommand $v) { return $v; }; return $f(${($_ = isset($this->services['App\Command\AppCreateTournamentCommand']) ? $this->services['App\Command\AppCreateTournamentCommand'] : $this->load(__DIR__.'/getAppCreateTournamentCommandService.php')) && false ?: '_'});
